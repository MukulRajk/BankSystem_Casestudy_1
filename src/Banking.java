...
class CustomerLogin {
    ...
    public void deposit(int accno) throws SQLException {
        ...
        if(result.next()) {
        	...
        	System.out.println("Account balance: "+result.getInt(10));
        }
        
        newAccountBalance = result.getInt(4) + amount;
    	...
    	stmt1.setInt(1, newAccountBalance);
    ...
    public void transferAmount(int accno) throws SQLException {
        ...
        int destinationAccNumber = sc.nextInt();
        sc.nextLine();
        ...
        if (result.next()) {
            ...
            if (sourceAccBalance >= amount) {
                ...
                if (rowsAffectedSource > 0) {
                    ...
                    updateDestinationStmt.setInt(2, destinationAccNumber);
...
class AdministratorLogin {
    ...
    public void searchCustomer() throws SQLException {
        ...
        if(result.next()) {
        	...
        	System.out.println("Account balance: "+result.getInt(2));
        	System.out.println("Account Holder name: "+result.getString(3));
        }
    }
    ...
    public void modifyCustomer() throws SQLException {
        ...
        if(result.next()) {
        	...
        	stmt1.setInt(1, newAccNo);
        	stmt1.setInt(2, newBal);
        	stmt1.setString(3, newName);
    ...
    public void login() throws SQLException {
        ...
        //"jdbc:mysql://localhost/test", "root", "rootroot"
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost/test","root","rootroot");
